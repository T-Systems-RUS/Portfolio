...
function _load_worker() {return _worker = require('./worker');}var _events;
...
function _load_jestWorker() {return _jestWorker = _interopRequireDefault(require('jest-worker'));}var _watchman_watcher;
function _load_watchman_watcher() {return _watchman_watcher = _interopRequireDefault(require('./lib/watchman_watcher'));}var _node;
...
class HasteMap extends (_events || _load_events()).default {
  ...
  workerOptions)
  {
    ...
    if (fileMetadata[(_constants || _load_constants()).default.VISITED]) {
      ...
      if (moduleMetadata != null) {
        ...
        map[fileMetadata[(_constants || _load_constants()).default.ID]] || (map[fileMetadata[(_constants || _load_constants()).default.ID]] = {});
  ...
  moduleMap)
  {
    ...
    const Watcher =
    canUseWatchman && this._options.useWatchman ? (_watchman_watcher || _load_watchman_watcher()).default :
