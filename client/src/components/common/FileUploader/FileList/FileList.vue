...
<style lang="scss" scoped>
  ...
  $upload-file-item-margin-bottom: $building-unit * 2;
  $upload-file-icon-margin-right: 8px;
  $upload-image-icon-margin-right: $building-unit;
  $upload-file-icon-size: $building-unit * 2;
  $upload-file-image-size: $building-unit * 3;
  $upload-file-name-right: $building-unit * 2;
  $status-icon-size: $building-unit * 2;
